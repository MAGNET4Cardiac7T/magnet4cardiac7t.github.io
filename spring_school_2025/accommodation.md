...
<div class="accomodation-container">
    ...
    <div style="display: flex; margin-bottom: 128px">
        ...
        <div style="font-size: 15px; max-width: 320px;">
            ...
            <div><a style="margin-top: 12px;font-size: 15px; background-color: #f07373" class="btn btn--primary"  target='_blank'  href='https://www.hotel-lindleinsmuehle.de/en/'>Book here</a></div>
        </div>
    ...
    <div style="display: flex; margin-bottom: 128px">
        ...
        <div style="font-size: 15px; max-width: 320px; margin-right: 12px">
            ...
            <div><a style="margin-top: 12px;font-size: 15px; background-color: #f07373" class="btn btn--primary"  target='_blank'  href='https://www.marriott.com/en-us/hotels/nueox-moxy-wuerzburg/overview/?scid=f2ae0541-1279-4f24-b197-a979c79310b0'>Book here</a></div>
        </div>
    ...
    <div style="display: flex; margin-bottom: 128px;">
        ...
        <div style="font-size: 15px; max-width: 320px;">
            ...
            <div><a style="margin-top: 12px;font-size: 15px; background-color: #f07373" class="btn btn--primary"  target='_blank'  href='https://www.marriott.com/en-us/hotels/nueac-ac-hotel-wuerzburg/overview/?scid=f2ae0541-1279-4f24-b197-a979c79310b0'>Book here</a></div>
        </div>    
    ...
    <div style="display: flex; margin-bottom: 128px">
        ...
        <div style="font-size: 15px; max-width: 320px; margin-right: 12px;">
            ...
            <div><a style="margin-top: 12px;font-size: 15px; background-color: #f07373" class="btn btn--primary"  target='_blank'  href='https://www.ghotel.de/hotels/wuerzburg/?gad_source=1&gclid=CjwKCAiAh6y9BhBREiwApBLHC4MPgwuRreDUyrR-gELcY1hUYSLojymZfE4FTaezFerMRS7QmsejYxoCfoIQAvD_BwE'>Book here</a></div>
        </div>    
    ...
    <div style="display: flex; margin-bottom: 128px; margin-top: 64px">
        ...
        <div style="font-size: 15px; max-width: 320px;">
            ...
            <div><a style="margin-top: 12px;font-size: 15px; background-color: #f07373" class="btn btn--primary"  target='_blank'  href='https://www.babelfish-hostel.de/intro/'>Book here</a></div>
        </div>
    ...
    <div style="display: flex; margin-bottom: 128px">
        ...
        <div style="font-size: 15px; max-width: 320px; margin-right: 12px;">
            ...
            <div><a style="margin-top: 12px;font-size: 15px; background-color: #f07373" class="btn btn--primary"  target='_blank'  href='https://www.hotel-regina-wuerzburg.de/en/'>Book here</a></div>
        </div>
    ...
    <div style="display: flex; margin-bottom: 128px">
        ...
        <div style="font-size: 15px; max-width: 320px;">
            ...
            <div><a style="margin-top: 12px;font-size: 15px; background-color: #f07373" class="btn btn--primary"  target='_blank'  href='https://www.jugendherberge.de/en/'>Book here</a></div>
        </div>
